...
#define reg_print_msg_error(text){REprintf("[NiftyReg ERROR] %s\n", text);}
  ...
  #define reg_exit(){ throw std::runtime_error("[NiftyReg] Exception"); }
  #else // NR_THROW_EXCEP
  #define reg_exit(){ fprintf(stderr,"[NiftyReg] Exit here. File: %s:%i\n",__FILE__, __LINE__); exit(1); }
...
mat44 reg_mat44_mul(mat44 const* mat, double scalar);
/* *************************************************************** */
